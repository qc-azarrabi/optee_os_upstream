...
#define CFG_8250_UART_FLUSH_TIMEOUT_US 10000
...
#define CFG_CONSOLE_MASK_INTERRUPTS 1
...
#define CFG_HW_UNIQUE_KEY_LENGTH 16
...
#define CFG_OPTEE_REVISION_MINOR 10
#define CFG_OS_REV_REPORTS_GIT_SHA1 1
/* CFG_PAGED_USER_TA is not set */
/* CFG_PAN is not set */
#define CFG_PAS_TA_HEAP_SIZE (4 * 1024)
